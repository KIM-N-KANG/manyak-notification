...
import com.google.firebase.messaging.BoundedFirebaseMessaging
...
class FcmConfig {
    ...
    fun firebaseMessaging(
        ...
        return createMessaging(app)
    }

    internal fun createMessaging(app: FirebaseApp): FirebaseMessaging = BoundedFirebaseMessaging.create(app)
}
